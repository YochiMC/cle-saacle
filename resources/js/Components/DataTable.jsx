...
export function DataTable({
  ...
  const [columnVisibility, setColumnVisibility] = useState({ created_at: false, updated_at: false });
  ...
  }, [rowSelection, globalFilter, columnVisibility, onSelectionChange, table]);
        ...
        <Table>
          <TableHeader className="bg-[#17365D]">
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id} className="hover:bg-[#17365D] border-b-slate-300">
              ...
              table.getRowModel().rows.map((row) => (
                ...
                >
                  {row.getVisibleCells().map((cell) => (
                    <TableCell key={cell.id} className="text-center align-middle py-3">
