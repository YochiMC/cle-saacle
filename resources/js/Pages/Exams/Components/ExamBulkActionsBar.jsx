...
/**
 * Componente: ExamBulkActionsBar
 * 
 * Barra inferior flotante para confirmar o cancelar la captura masiva de calificaciones.
 */
const ExamBulkActionsBar = ({ 
    isEditingMode, 
    setIsEditingMode, 
    requestSaveGlobal 
}) => {
...
export default React.memo(ExamBulkActionsBar);
